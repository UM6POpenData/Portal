...
(function() {
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'About',
										'page_location': 'https://uodp.org/#about',
									});
								},
							],
						},
	...
	// Initialize "On Visible" animations.
		onvisible.add('.text-component.style-1', { style: 'fade-up', speed: 750, intensity: 0, threshold: 3, delay: 1000, stagger: 125, staggerSelector: ':scope > *', replay: false });
		onvisible.add('.container-component.style-3', { style: 'fade-in', speed: 750, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.container-component.style-4', { style: 'fade-in', speed: 750, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.container-component.style-2', { style: 'fade-in', speed: 750, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.style-2', { style: 'fade-left', speed: 750, intensity: 0, threshold: 3, delay: 1000, replay: false });
		onvisible.add('.text-component.style-3', { style: 'fade-left', speed: 750, intensity: 0, threshold: 3, delay: 1125, replay: false });
		onvisible.add('.container-component.style-1', { style: 'fade-in', speed: 750, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.buttons-component.style-2', { style: 'fade-up', speed: 750, intensity: 0, threshold: 3, delay: 1250, replay: false });
		onvisible.add('.icons-component.style-1', { style: 'zoom-in', speed: 1000, intensity: 5, threshold: 1, delay: 500, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('.text-component.style-7', { style: 'fade-up', speed: 750, intensity: 0, threshold: 3, delay: 1000, stagger: 125, staggerSelector: ':scope > *', replay: false });
		onvisible.add('.list-component.instance-1', { style: 'fade-left', speed: 750, intensity: 0, threshold: 3, delay: 1125, replay: false });
		onvisible.add('.text-component.style-6', { style: 'fade-left', speed: 750, intensity: 0, threshold: 4, delay: 1000, replay: false });
		onvisible.add('.text-component.style-8', { style: 'fade-up', speed: 750, intensity: 0, threshold: 3, delay: 1125, stagger: 125, staggerSelector: ':scope > *', replay: false });
