...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'fade-up', speed: 750, intensity: 0, threshold: 3, delay: 1000, stagger: 125, staggerSelector: ':scope > *', replay: false });
		onvisible.add('.container.style3', { style: 'fade-in', speed: 750, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.container.style1', { style: 'fade-in', speed: 750, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style2, h2.style2, h3.style2, p.style2', { style: 'fade-left', speed: 750, intensity: 0, threshold: 3, delay: 1000, replay: false });
		onvisible.add('h1.style3, h2.style3, h3.style3, p.style3', { style: 'fade-left', speed: 750, intensity: 0, threshold: 3, delay: 1125, replay: false });
		onvisible.add('h1.style6, h2.style6, h3.style6, p.style6', { style: 'fade-left', speed: 750, intensity: 0, threshold: 4, delay: 1000, stagger: 125, staggerSelector: ':scope > *', replay: false });
		onvisible.add('.buttons.style2', { style: 'fade-up', speed: 750, intensity: 0, threshold: 3, delay: 1250, replay: false });
		onvisible.add('.icons.style1', { style: 'zoom-in', speed: 1000, intensity: 5, threshold: 1, delay: 500, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('h1.style7, h2.style7, h3.style7, p.style7', { style: 'fade-up', speed: 750, intensity: 0, threshold: 3, delay: 1000, stagger: 125, staggerSelector: ':scope > *', replay: false });
		onvisible.add('#list01', { style: 'fade-left', speed: 750, intensity: 0, threshold: 3, delay: 1125, replay: false });
		onvisible.add('h1.style8, h2.style8, h3.style8, p.style8', { style: 'fade-up', speed: 750, intensity: 0, threshold: 3, delay: 1125, stagger: 125, staggerSelector: ':scope > *', replay: false });
